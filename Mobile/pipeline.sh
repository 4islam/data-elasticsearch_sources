...
node ../quran.js Arabic_noor ar_original_normalized_noor > ar_original_normalized_noor.json
#node ../quran.js Arabic_noor ar_normalized_phonetic > ar_normalized_phonetic_noor.json  Same as Uthmani
node ../quran.js Arabic_noor ar_root_normalized_phonetic_noor > ar_root_phonetic_noor.json
node ../quran.js Arabic_noor ar_root_noor > ar_root_noor.json
node ../quran.js Arabic_noor ar_stems_normalized_noor > ar_stems_normalized_noor.json
node ../quran.js Arabic_noor ar_stems_normalized_phonetic_noor > ar_stems_normalized_phonetic_noor.json
