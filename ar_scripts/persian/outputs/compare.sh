...
echo '<html>
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>div{white-space: pre;} *{font-family: 'Times New Roman'; font-size: 38px; line-height:1.7em; text-align: justify;}</style></head>
