...
outputstats=ar_scripts/persian/outputs/$(date +%F"_"%H).stats.txt
echo '<html>
...
dwdiff -s -d" " ar_scripts/persian/original/tokenized_100.txt ar_scripts/persian/outputs/verses_100.txt 2> $outputstats
